@extends('layouts.app')
@section('title', 'Create Gembala')
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('gembala.index') }}">Gembala</a></li>
        <li class="breadcrumb-item active">Create</li>
    </ol>
@endsection
@section('content')
    @include('admin.any.index')
    <form action="{{ route('gembala.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="row">
            <div class="col-lg-12">
                <div class="card border-0">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('gembala.index') }}" class="btn btn-secondary"> <i class="bi bi-arrow-left"></i>
                            Kembali</a>
