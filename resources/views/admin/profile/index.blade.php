                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <img style="width: 100px;height: 100px;"
                                ...
                                src="{{ asset('images/favicon.png') }}" alt="Profile Image">
                            <input id="image" type="file" name="image" data-max-file-size="500KB">
                        </div>

                        <div class="form-group">
                            <label for="name">Name <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="name" required value="Peter">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" required value="peter@gmail.com">
                            @error('email')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
